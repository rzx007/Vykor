...
import { assertArtifacts, renderStableReleaseNotes } from "./release-safety.mjs";
...
function main() {
  ...
  if (!path) throw new Error("usage: release-assets.mjs <write-notes|assert-artifacts> <path>");
