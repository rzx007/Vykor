              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-ink shrink-0 text-[12.5px] font-medium">{row.label}</span>
                    <span
              ...
              {diffs.map((d, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-green shrink-0 tabular-nums">+{d.add}</span>
                    {d.del > 0 && <span className="text-red shrink-0 tabular-nums">−{d.del}</span>}
                  </button>
                </span>
              ))}
              <button
        ...
        createPortal(
          ...
          >
            <div className="border-line flex items-center justify-between border-b px-2.5 py-1.5 font-mono text-[11px]">
              <span className="text-ink-2 min-w-0 truncate">{preview.file}</span>
